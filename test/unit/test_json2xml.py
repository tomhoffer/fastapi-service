...
@pytest.mark.parametrize("input, expected_output", [
    ('{"foo": 7}', '<ITEM type="object"><ITEM key="foo" type="integer" value="7" /></ITEM>'),
    ('{"foo": "7"}', '<ITEM type="object"><ITEM key="foo" type="string" value="7" /></ITEM>'),
    ('{"foo": true}', '<ITEM type="object"><ITEM key="foo" type="boolean" value="true" /></ITEM>'),
    ('{"foo": 1.5}', '<ITEM type="object"><ITEM key="foo" type="float" value="1.5" /></ITEM>'),
])
...
@pytest.mark.parametrize("input, expected_output", [
    ('{}', '<ITEM type="object" />'),
    ('[]', '<ITEM type="list" />'),
    ('[1,2]', '<ITEM type="list"><ITEM type="integer" value="1" /><ITEM type="integer" value="2" /></ITEM>'),
    ('{"a": 1, "b": 2}',
...
@pytest.mark.parametrize("input, expected_output", [
    ('{"mylist": []}', '<ITEM type="object"><ITEM key="mylist" type="list" /></ITEM>'),
    ('[[]]', '<ITEM type="list"><ITEM type="list" /></ITEM>'),
    ('{"mylist": [[]]}', '<ITEM type="object"><ITEM key="mylist" type="list"><ITEM type="list" /></ITEM></ITEM>'),
    ('{"mylist": [[true]]}',
    ...
    ('{"myobj": {}}', '<ITEM type="object"><ITEM key="myobj" type="object" /></ITEM>'),
    ('{"myobj": {"a": 1}}',
