...
f = faker.Faker()
connection = psycopg2.connect(dbname="pm_assignment", user="PM_user", password="PM_password", host="localhost")
...
with connection.cursor() as cursor:
    ...
    psycopg2.extras.execute_batch(cursor, "INSERT INTO records (email, text) VALUES (%s, %s)", records,
                                  page_size=10 ** 3)
